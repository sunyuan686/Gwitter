(()=>{var e={3541:function(e,t,i){"use strict";var o=i(2676),r=i(5271),n=i(8751),a=i(5045),s=i(2686);i(3052);var l=i(4767);let d={request:{token:["9c48ed2297d7d9bf9447","6de723dbf1a6e4adeacd"],clientID:"694df1779e48d5a450d3",clientSecret:"23420dd29f671adc5107a5565ed47f655f8e1260",pageSize:6,autoProxy:"https://cors-anywhere.azm.workers.dev/https://github.com/login/oauth/access_token",owner:"ruanyf",repo:"weekly"},app:{onlyShowOwner:!1,enableRepoSwitcher:!1,enableAbout:!1,enableEgg:!1}};window.GWITTER_CONFIG&&(d={...d,...window.GWITTER_CONFIG});let c=d,p=e=>l.Z.create({baseURL:"https://api.github.com/",headers:{Accept:"application/json",Authorization:`bearer ${e}`}}),u=p(c.request.token.join("")),h=e=>{let t=`
  ...
  `;return e.post("/graphql",{query:o,variables:{subjectId:t,body:i}})},w=async e=>(await l.Z.get("https://api.github.com/user",{headers:{Authorization:`bearer ${e}`}})).data,v=async e=>(await l.Z.post(c.request.autoProxy,{client_id:c.request.clientID,client_secret:c.request.clientSecret,code:e})).data,y=async(e,t,i)=>{let o=`
...
`,tO=a.Z.span`
  font-size: 14px;
  color: #666;
`,tP=()=>{let{user:e}=ei(),[t,i]=(0,r.useState)([]),[n,a]=(0,r.useState)(!0),[s,l]=(0,r.useState)(!0),[d,p]=(0,r.useState)(!0),[g,m]=(0,r.useState)([]),[x,f]=(0,r.useState)(!1),[b,w]=(0,r.useState)(()=>t_()||{owner:c.request.owner,repo:c.request.repo}),[v,y]=(0,r.useState)(null),j=(0,r.useRef)(null),k=(0,r.useRef)(n),$=(0,r.useRef)(null),C=(0,r.useRef)(null==e?void 0:e.login),S=(0,r.useRef)(b),z=(0,r.useRef)(!1),E=(0,r.useRef)(null),Z=(0,r.useRef)(0);(0,r.useEffect)(()=>{k.current=n},[n]),(0,r.useEffect)(()=>{C.current=null==e?void 0:e.login},[null==e?void 0:e.login]),(0,r.useEffect)(()=>{S.current=b},[b]),(0,r.useEffect)(()=>{Z.current=window.scrollY},[]);let R=(0,r.useCallback)(async()=>{let e=S.current;console.log("loadIssues called for repo:",`${e.owner}/${e.repo}`,"cursor:",j.current,"isLoading:",k.current);try{let t=(await u.post("/graphql",h({owner:e.owner,repo:e.repo,cursor:j.current,pageSize:c.request.pageSize}))).data.data.repository.issues,{hasNextPage:o,endCursor:r}=t.pageInfo;p(o),j.current=r;let n=[...g,...t.nodes];m(n),i(e=>[...e,...I(t.nodes,C.current)]),a(!1),z.current=!1}catch(e){console.error("err:",e),a(!1),z.current=!1}},[g]),_=(0,r.useCallback)(async()=>{console.log("Resetting and loading new repo:",b),i([]),m([]),p(!0),j.current=null,z.current=!1,Z.current=window.scrollY,a(!0),l(!0),y(null);try{var e,t;let o=await u.post("/graphql",h({owner:b.owner,repo:b.repo,cursor:null,pageSize:c.request.pageSize}));if(o.data.errors)throw Error((null==(t=o.data.errors[0])?void 0:t.message)||"GraphQL Error");if(!(null==(e=o.data.data)?void 0:e.repository))throw Error(`Repository ${b.owner}/${b.repo} not found or private`);let r=o.data.data.repository.issues,{hasNextPage:n,endCursor:s}=r.pageInfo;p(n),j.current=s,m(r.nodes),i(I(r.nodes,C.current)),a(!1),l(!1),y(null)}catch(e){console.error("Error loading new repo:",e),a(!1),l(!1),y(e instanceof Error?e.message:"Failed to load repository")}},[b.owner,b.repo]),T=(0,r.useCallback)((e,t)=>{console.log("Repo changed to:",{owner:e,repo:t}),w({owner:e,repo:t}),tR(e,t)},[]),A=(0,r.useCallback)(()=>{E.current&&clearTimeout(E.current),E.current=setTimeout(()=>{let e=window.scrollY,i=Z.current,o=e>i;if(Z.current=e,console.log("\uD83C\uDFAF handleScroll check - scrollY:",e,"lastScrollY:",i,"scrollingDown:",o,"isLoading:",k.current,"hasNextPage:",d,"triggered:",z.current),!o)return void console.log("❌ handleScroll blocked - scrolling up");if(k.current||!d||z.current)return void console.log("❌ handleScroll blocked - already loading, no more pages, or already triggered");if(0===t.length)return void console.log("❌ handleScroll blocked - no issues loaded yet");let r=$.current;if(!r)return void console.log("❌ handleScroll blocked - no last issue element");let n=r.getBoundingClientRect(),s=window.innerHeight,l=n.top<s;if(console.log("\uD83D\uDCCF Scroll metrics - lastIssue.top:",n.top,"viewportHeight:",s,"isVisible:",l),!l)return void console.log("❌ handleScroll blocked - last issue not yet visible");console.log("✅ handleScroll triggered, starting new load for repo:",S.current),z.current=!0,a(!0),R()},200)},[R,d,t.length]);return(0,r.useEffect)(()=>{x||(console.log("App mounted, initializing data load"),l(!0),_(),f(!0))},[x,_]),(0,r.useEffect)(()=>{x&&(window.removeEventListener("scroll",A),l(!0),_())},[b.owner,b.repo]),(0,r.useEffect)(()=>{if(x&&d&&t.length>0){console.log("\uD83D\uDCDD Preparing to add scroll listener, issues count:",t.length);let e=setTimeout(()=>{$.current?(console.log("✅ Adding scroll listener, lastIssueRef exists"),window.addEventListener("scroll",A,!1)):console.log("⚠️ lastIssueRef still null, will retry on next render")},100);return()=>{clearTimeout(e),console.log("\uD83D\uDDD1️ Removing scroll listener"),window.removeEventListener("scroll",A),E.current&&(clearTimeout(E.current),E.current=null)}}},[x,d,A,t.length]),(0,r.useEffect)(()=>{g.length>0&&i(I(g,null==e?void 0:e.login))},[null==e?void 0:e.login,g]),(0,r.useEffect)(()=>()=>{E.current&&(clearTimeout(E.current),E.current=null)},[]),(0,o.jsxs)(tT,{children:[(0,o.jsx)(tZ,{onRepoChange:T,currentRepo:b,isLoading:s,error:v}),c.app.enableAbout&&(0,o.jsx)(P,{owner:b.owner,repo:b.repo}),t.length>0&&(0,o.jsx)(o.Fragment,{children:(0,o.jsx)(tA,{children:t.map((e,i)=>(0,o.jsx)("div",{ref:i===t.length-1?$:void 0,children:(0,o.jsx)(to,{issue:e,repoOwner:b.owner,repoName:b.repo})},`${e.id}-${i}`))})}),n&&!v&&(0,o.jsxs)(tA,{children:[(0,o.jsx)(tp,{}),(0,o.jsx)(tp,{})]}),v&&(0,o.jsx)(tA,{children:(0,o.jsxs)(tL,{children:[(0,o.jsx)(tM,{children:"⚠️"}),(0,o.jsx)(tD,{children:v}),(0,o.jsx)(tO,{children:"Please check the repository name and try again."})]})}),c.app.enableEgg&&!d&&!v&&(0,o.jsx)(X,{})]})},tq=a.Z.div`
  box-sizing: border-box;
  * {
    box-sizing: border-box;
  }
